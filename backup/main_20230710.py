...
def data_sort():
    diff_date = datetime.strftime(this_monday-relativedelta(days=30), '%Y-%m-%d')+' 23:59:59' # 取30天內開團的商品, 設定到 YYYY-mm-dd 23:59:59
...
def amount_limit():
    diff_date = datetime.strftime(this_monday, '%Y-%m-%d')+' 23:59:59' # 取爬蟲當天內還開團的商品, 設定到 YYYY-mm-dd 23:59:59
    diff_date = datetime.strptime(diff_date, '%Y-%m-%d %H:%M:%S')
