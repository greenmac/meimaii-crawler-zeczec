...
def get_crowdfunding_info(crowdfunding_url, time_sleep):
    ...
    projects_url_list = soup.select('.container >.container >.flex >.w-full > .text-black > .block')
...
def get_pre_order_info(pre_order_url, time_sleep):
    ...
    projects_url_list = soup.select('.border-t >.container >.flex')[0]
...
if __name__ == '__main__':    
    ...
    # get_projects_info('https://www.zeczec.com/projects/plum',0)
